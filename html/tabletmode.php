...
<style type="text/css">
body {
/*      background-image: url("/images/greenhousebg5.jpg"); */
...
<script>
			...
			AmCharts.ready(function () {
				...
				axisfronttempC.color = "#8f8a8a";
				// bottom text
                axisfronttempC.bottomTextYOffset = -25;
				axisfronttempC.bottomTextColor = "#8f8a8a";
				...
				axisfronttempF.color = "#8f8a8a";
				// bottom text
                axisfronttempF.bottomTextYOffset = -30;
				axisfronttempF.bottomTextColor = "#8f8a8a";
